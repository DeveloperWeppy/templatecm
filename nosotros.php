  ...
  <![endif]-->
    ...
    <main>
                        ...
                        <div class="col-md-12">
                            <div class="about4__content">
                                ...
                                <h3>We assured to you that we will provide responsible treatment
                                    to you. It’s our duty for any <span>patients</span>. You are welcome to
                                    HounLare medical & caregiver services center.</h3>
                                <a href="contact.html" class="btn3"> <span>Contact Us</span> <i class="icofont-rounded-double-right"></i> </a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="feature1">
            <div class="container">
                <div class="feature1__carousel owl-carousel owl-theme">
                    <div class="feature1__item text-center feature1__bg-01">
                        <div class="feature1__thumb">
                            <i class="flaticon-hospital-bed"></i>
                        </div>
                        <h4>Patients Beds 909</h4>
                    </div>
                    <div class="feature1__item text-center feature1__bg-02">
                        <div class="feature1__thumb">
                    ...
                    <div class="feature1__item text-center feature1__bg-02">
                        <div class="feature1__thumb">
                            <i class="flaticon-electrotherapy"></i>
                        </div>
                        <h4>ICU Beds 80</h4>
                    </div>
                            ...
                            <div class="about1__wrapper">
                                ...
                                <div class="about1__content">
                                    ...
                                    <div class="about1__btn">
                                        ...
                                        <a href="service-details.html" class="btn5 ml-35 d-none d-sm-inline-block">Learn More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <!-- |==========================================| -->
        <!-- |=====|| Counter Start ||===============| -->
        <section class="counter1 counter1__bg-02">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <a href="doctors.html" class="btn3"> <span>See All Doctors</span> <i class="icofont-rounded-double-right"></i> </a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-xl-8 offset-xl-2">
                            <div class="care2__wrapper text-center">
                                ...
                                <div class="care2__content mt-35">
                                    ...
                                    <a href="contact.html" class="btn3"> <span>Take Treatment</span> <i class="icofont-rounded-double-right"></i> </a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="testimonial1">
            <div class="testimonial1__thumb1">
                ...
                <div class="testimonial1__thumb1--btn">
                    <a data-fancybox="gallery_1" data-caption="Your caption will be here." href="https://youtu.be/8rPB4A3zDnQ"><i class="far fa-play-circle"></i></a>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="testimonial1__btn">
                                <a href="#" class="btn3"> <span>Know More About Us</span> <i class="icofont-rounded-double-right"></i> </a>
                            </div>
                        </div>
                    </div>
                </div>
